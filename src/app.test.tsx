...
vi.mock('./components/streaming_video_component/streaming_video_component', () => ({
  StreamingVideoComponent: ({ onTrackEvent }: { onTrackEvent: (event: VideoEvent) => void }) => {
...
describe('MyEdSpaceApp', () => {
  it('should not show the video to unauthenticated users', () => {
    ...
    expect(screen.queryByTestId('streaming-video-component')).not.toBeInTheDocument();
  });
